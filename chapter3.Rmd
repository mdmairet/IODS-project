...
From the model P-values, we see that absences and going out are likely relevant variables to explain high_use of alcohol.  However, final grade and health show that the data are providing little evidence that these variables are needed to explain high_use.

From the Odd Ratio table, we see that absences and going out have an OR greater than 1.  This would imply that these variables are positively associated with high_use of alcohol.  Going out has a Odd Ratio of 2 showing a very strong positive association with high_use of alcohol.
