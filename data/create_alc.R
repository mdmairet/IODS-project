...
# Date: 2021-11-16
# This script is for assignment 3.
# Data file is from: https://archive.ics.uci.edu/ml/datasets/Student+Performance

# read datasets from my data folder.
por <- read.table("~/IODS-project/IODS-project/data/student-por.csv", sep = ";", header = TRUE)
math <- read.table ("~/IODS-project/IODS-project/data/student-mat.csv", sep = ";", header = TRUE)
...
# The below code is from: https://raw.githubusercontent.com/rsund/IODS-project/master/data/create_alc.R
# Credits to: Reijo Sund
